...
namespace NFine.Code
{
    public class WebHelper
    {
        ...
        /// 下载网络图片
        /// </summary>
        /// <param name="imgurl">网络图片路径</param>
        /// <param name="savepath">存放物理路径</param>
        /// <param name="type">图片格式</param>
        public static void UploadUrlImg(string imgurl, string savepath, string type)
        {
            ...
            switch (type)
            {
                case ".jpg":
                    ...
                    break;
                case ".png":
                    img.Save(savepath, ImageFormat.Png);   //保存
                    break;
                case ".gif":
                    img.Save(savepath, ImageFormat.Gif);   //保存
                    break;
                case ".bmp":
                    img.Save(savepath, ImageFormat.Bmp);   //保存
                    break;
                default:
                    break;
