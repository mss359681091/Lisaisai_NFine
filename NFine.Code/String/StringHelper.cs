...
namespace NFine.Code
{
    ...
    /// 15、AddChar(string param1 = "") 为逗号分隔符字符串添加单引号
    /// 16、GetStrJionChar(string str) 拼接一个新的字符串，如（0001,0002,0003-->'0001','0002','0003'）
    /// </summary>
    public class StringHelper
    {
        ...
        #region 拼接一个新的字符串，如（0001,0002,0003-->'0001','0002','0003'）
        /// <summary>
        ...
        /// <returns></returns>
        public static string StringToImage(string buffer, string path = "")
        {
            using (MemoryStream ms = new MemoryStream(Convert.FromBase64String(buffer)))
            {
        ...
        public static string ImageConvertString(string imagepath)
        {
