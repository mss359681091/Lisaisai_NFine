jQuery(function () {
    ...
    function t(e) {
        ...
        if (e !== k) {
            switch (c.removeClass("state-" + k), c.addClass("state-" + e), k = e) {
                ...
                case "finish":
                    a = n.getStats(),
                    a.successNum ? $.modalMsg('上传成功', 'success') :
    ...
    n = WebUploader.create({
        ...
        disableGlobalDnd: !0,
        chunked: !0,
        server: "/Canchong/WebGoods/UpLoadProcess",
