jQuery(function () {
    ...
    n = WebUploader.create({
        ...
        disableGlobalDnd: !0,
        chunked: !0,
        server: "/Home/SingleUpLoadProcess",
        formData: { "param_uploader": o("#param_uploader").val(), "isthumbnai": o("#thumbnai").val() },
        fileNumLimit: 1,
        ...
        if (o("#thumbnai").val() == "1") {
            parent.fnGetResult(o("#flag").val(), response.F_ThumbnailPath);
        }
        else {
            parent.fnGetResult(o("#flag").val(), response.F_FilePath);
        }
